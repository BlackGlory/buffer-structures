import { Int8 } from '@objects/int8.js'
...
describe('Int8', () => {
  test('create', () => {
    ...
    const result = Int8.create(allocator, int8(1))

    expect(result).toBeInstanceOf(BaseObject)
    expect(result.get()).toStrictEqual(int8(1))
  ...
  test('from', () => {
    const allocator = new Allocator(new ArrayBuffer(100))
    const obj = Int8.create(allocator, int8(1))
    const allocate = vi.spyOn(allocator, 'allocate')

    const result = Int8.from(allocator, obj.byteOffset)
  ...
  describe('destory', () => {
    ...
    describe('reference counted', () => {
      test('does not call allocator.free()', () => {
        ...
        const obj1 = Int8.create(allocator, int8(1))
  ...
  test('get', () => {
    ...
    expect(result).toStrictEqual(int8(1))
  })
  ...
  test('set', () => {
    ...
    expect(obj.get()).toStrictEqual(int8(2))
  })
