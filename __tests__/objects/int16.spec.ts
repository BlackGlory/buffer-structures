...
describe('Int16', () => {
  test('create', () => {
    ...
    new Int16(allocator, 1)

    expect(allocator.allocate).toBeCalledTimes(1)
    expect(allocator.allocate).toBeCalledWith(Int16View.byteLength)
  })
  ...
  describe('destory', () => {
    it('calls allocator.free()', () => {
      ...
      const result = new Int16(allocator, 1)
    ...
    describe('reference counted', () => {
      test('does not call allocator.free()', () => {
        ...
        const obj1 = new Int16(allocator, 1)
  ...
  test('clone', () => {
    ...
    const obj = new Int16(allocator, 1)
